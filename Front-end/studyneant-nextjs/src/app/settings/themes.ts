...
export const BUILT_IN_THEMES: Record<string, ThemeDef> = {
    ...
    */
    ...
    cottoncandy: {
        ...
        vars: {
            "--dash-bg-page": "#fceaf2",
            "--dash-bg-widget": "rgba(255,255,255,0.75)",
            "--dash-bg-handle": "rgba(250,225,235,0.95)",
            "--dash-bg-sidebar": "rgba(255,255,255,0.75)",
            "--dash-topbar-bg": "rgba(255,255,255,0.5)",
            "--dash-bottomnav-bg": "rgba(255,255,255,0.5)",
            "--dash-nav-hover-bg": "rgba(255,133,179,0.12)",
            "--dash-accent": "#7bc4e8",
            "--dash-accent-warm": "#ff85b3",
            "--dash-accent-glow": "rgba(255,133,179,0.22)",
            "--dash-btn-text": "#ffffff",
            "--dash-text-primary": "#2d2442",
            "--dash-text-muted": "rgba(45,36,66,0.6)",
            "--dash-border": "rgba(255,133,179,0.2)",
            "--dash-border-hover": "rgba(255,133,179,0.35)",
            "--dash-bg-image":
                "radial-gradient(circle at 50% 50%, rgba(123,196,232,0.2), transparent 50%), radial-gradient(circle at 80% 20%, rgba(255,133,179,0.15), transparent 40%), radial-gradient(ellipse at center, transparent 50%, rgba(255,255,255,0.4) 100%)",
        },
    },
    crimson: {
        id: "crimson",
